...
async function makeHockeyRequest(endpoint, params = {}) {
    // JAVÍTÁS: Nincs többé process.env olvasás
...
try {
        ...
        // JAVÍTÁS: A makeRequest már csak 2xx válasszal tér vissza, vagy hibát dob.
        // Ha null-t ad vissza (auth hiba), azt is propagáljuk.
...
// JAVÍTÁS: NEM nyeljük el a hibát. Dobjuk tovább, hogy a DataFetch Factory elkapja.
        // A 'null' visszatérés elrejti a hiba okát.
        throw error;
}
}
