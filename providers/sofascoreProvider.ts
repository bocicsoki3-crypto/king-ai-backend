// providers/sofascoreProvider.ts (v54.2 - Hibás Hiányzó Logika Javítva)
// MÓDOSÍTÁS: A processSofascoreLineups javítva, hogy ne jelölje
// a meccs előtti kezdőket (0-s rating) hiányzóként.
...
let foundTeam: ISofascoreTeam | null = null;
    ...
    foundTeam = teamsToSearch.find(t => t.name.toLowerCase() === normalizedInput) ||
null;
    if (foundTeam) {
...
// --- JAVÍTOTT processSofascoreLineups (v54.2) ---
...
players.forEach(p => {
            ...
            // === JAVÍTÁS (v54.2) ===
            // A 'ratingValue === 0' hibásan azonosította a meccs előtti
            // kezdőket hiányzóként. Ezt a logikát eltávolítottuk.
            /* [TÖRÖLVE]
