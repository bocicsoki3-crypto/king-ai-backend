...
* JAVÍTÁS (v1.2 - UI Fix): A radiális diagram jelmagyarázatának
* színes négyzet (legend-color-box) elemei megkapták
* a 'home', 'draw', 'away' osztályokat a CSS alapú színezéshez.
**************************************************************/
...
function getRadialChartHtml(pHome, pDraw, pAway) {
    ...
    // JAVÍTÁS (v1.2): Színes négyzetek osztályozva (home, draw, away)
    return `
