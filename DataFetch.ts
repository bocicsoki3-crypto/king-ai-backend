...
[cite_start]//    és '...finalResult' [cite: 1687] operátorok automatikusan
...
// 1. xG PRIORITÁSI LÁNC (MÓDOSÍTVA v61.0)
        ...
        {
            [cite_start]// A Model.ts számolja ki az átlagot [cite: 1565-1566], itt csak továbbítjuk a komponenseket
...
export async function getRostersForMatch(options: {
    ...
    try {
        ...
        const providerOptions = {
            ...
            [cite_start]// hogy a provider-szintű cache-t (pl. apiSportsLineupCache [cite: 1109]) használhassa, ha elérhető.
        };

        // Meghívjuk a sport-specifikus adatlekérőt
        // Ez a hívás (pl. apiSportsProvider.fetchMatchData) már tartalmazza
        [cite_start]// az 'availableRosters'-t [cite: 1331-1383] a válaszában.
