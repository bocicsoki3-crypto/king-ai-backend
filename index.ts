// --- index.ts (v63.3 - Előzmény JSON Mentés Javítás) ---
// MÓDOSÍTÁS (Feladat 6):
// 1. ÚJ OSZLOP: A 'getHistorySheet' most már tartalmazza a 'JSON_Data' oszlopot.
// 2. IAnalysisDataToSave: Kiegészítve 'fullAnalysisData: any' mezővel.
// 3. saveAnalysisToSheet: Most már a teljes 'analysisData' objektumot menti JSON stringként.
// 4. getAnalysisDetailFromSheet: Most már beolvassa a 'JSON_Data' oszlopot a kliens számára.
...
app.post('/login', async (req: Request, res: Response) => {
    try {
        ...
        if (!isMatch) {
           ...
           console.warn("Sikertelen bejelentési kísérlet (hibás jelszó).");
