...
const { pure_mu_h, pure_mu_a, source: quantSource } = estimatePureXG(
            ...
            advancedData // Ez tartalmazza a P1-es 4-komponensű adatokat [cite: 2036-2038]
        );
...
const strategistInput = {
            ...
            quantReport: { pure_mu_h, pure_mu_a, source: quantSource },
            specialistReport: { mu_h, mu_a, log: modifierLog },
            simulatorReport: sim,
